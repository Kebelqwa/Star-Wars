...
Navigate to the extracted folder and copy SWTG-files folder or the SWTG.xml
Open Cockatrice then navigate to "Card Database" > "open custom image folder" and "Card Database" > "open custom set folder"
Move "SWTG-files" folder to "custom image" folder and the SWTG.xml file to the "custom sets" folder
